        ...
        <div className="bg-card mx-auto w-full max-w-3xl rounded-lg p-8 shadow-md">
          ...
          <ol className="text-foreground list-decimal space-y-4 pl-6 text-base">
            <li>
              ...
              <br />
              This SLA is incorporated into and made part of the Terms of
              Service.
            </li>
            <li>
              <strong>Service Availability</strong>
              <br />
              Fleet Fusion commits to maintaining 99.9% uptime per calendar
              month for the Fleet Fusion platform, excluding scheduled
              maintenance and force majeure events.
              <br />
              <span className="mt-2 block">
                <strong>Uptime Definition:</strong> Availability of all critical
                services necessary to operate fleet management features,
                excluding third-party provider outages.
              </span>
            </li>
            <li>
              ...
              hours (typically between 12:00 AM – 4:00 AM MST).
              <br />
              Scheduled maintenance windows do not count against uptime
              guarantees.
            </li>
            <li>
              ...
              <table className="mb-2 w-full border text-sm">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border px-2 py-1">
                      Within 4 business hours (Priority SLA)
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="border px-2 py-1">
                      Email + Dedicated CSM + Priority Queue
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="border px-2 py-1">
                      24/7 Escalation for Critical Issues
                    </td>
                  </tr>
                </tbody>
              </table>
              Enterprise customers are assigned a Dedicated Customer Success
              Manager (CSM).
            </li>
            <li>
              ...
              <table className="mb-2 w-full border text-sm">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border px-2 py-1">
                      Platform unusable; core business impact (e.g., no access,
                      dispatch failure)
                    </td>
                  ...
                  <tr>
                    ...
                    <td className="border px-2 py-1">
                      General questions or minor cosmetic issues
                    </td>
            ...
            <li>
              ...
              <br />
              If Fleet Fusion fails to meet the 99.9% uptime guarantee in any
              calendar month, Customers are eligible for a service credit:
              <ul className="list-disc pl-6">
                <li>
                  Credit Amount: 5% of the monthly fee for each full hour of
                  downtime beyond the threshold, up to 50% of that month’s
                  invoice.
                </li>
                <li>
                  ...
                  <ul className="list-disc pl-6">
                    <li>
                      Submit a written request to support@fleetfusion.app within
                      30 days of the downtime event.
                    </li>
                    <li>
                      Include timestamps, impact descriptions, and any relevant
                      supporting documentation.
                    </li>
                  </ul>
                </li>
                <li>
                  Service credits are the sole and exclusive remedy for SLA
                  violations.
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul className="list-disc pl-6">
                <li>
                  Factors outside Fleet Fusion’s control (e.g., natural
                  disasters, ISP failures).
                </li>
                <li>
                  Customer-side issues (e.g., hardware failures,
                  misconfigurations).
                </li>
