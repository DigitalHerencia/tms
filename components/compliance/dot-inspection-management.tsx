...
interface DOTInspectionManagementProps {
  orgId: string;
}

// Mock data for development
const mockInspections: DOTInspection[] = [
  {
    id: '1',
    vehicleId: 'v1',
    vehicleUnit: 'TRK-001',
    ...
    violations: 0,
    score: 95,
    reportUrl: '/reports/inspection-1.pdf',
  },
  {
    id: '2',
    vehicleId: 'v2',
    ...
    inspector: 'DOT Officer',
    location: 'I-75 Mile 245',
    violations: 3,
    score: 60,
    reportUrl: '/reports/inspection-2.pdf',
    notes: 'Brake violations found',
  },
  {
    id: '3',
    vehicleId: 'v3',
...
export function DOTInspectionManagement({ orgId }: DOTInspectionManagementProps) {
  const [inspections] = useState<DOTInspection[]>(mockInspections);
