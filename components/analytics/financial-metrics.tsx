...
import type { ExpenseMetrics, ProfitabilityMetrics } from '@/types/analytics'; // Assuming types are defined in @/types
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-md border border-gray-200 bg-black p-4">
        <h3 className="mb-4 text-lg font-bold text-white">Revenue & Expenses</h3>
        <ChartContainer
          config={{
            revenue: {
              label: 'Revenue',
        ...
        >
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={financialData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
              ...
              <Legend />
              <Line type="monotone" dataKey="revenue" stroke="--color-revenue" name="Revenue" />
              <Line type="monotone" dataKey="expenses" stroke="--color-expenses" name="Expenses" />
              <Line type="monotone" dataKey="profit" stroke="--color-profit" name="Profit" />
            </LineChart>
          </ResponsiveContainer>
        </ChartContainer>
      </div>
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className="rounded-md border border-gray-200 bg-black p-4">
          <h3 className="mb-4 text-lg font-bold text-white">Financial Summary</h3>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-b">
                  ...
                  <td className="p-2 text-right text-sm text-green-600">+12.0%</td>
                </tr>
                <tr className="border-b">
                  ...
                  <td className="p-2 text-right text-sm text-red-600">+10.0%</td>
                </tr>
                <tr className="border-b">
                  ...
                  <td className="p-2 text-right text-sm text-green-600">+17.4%</td>
                </tr>
                <tr className="border-b">
                  ...
                  <td className="p-2 text-right text-sm text-green-600">+1.3%</td>
                </tr>
                <tr>
                  ...
                  <td className="p-2 text-right text-sm text-green-600">+6.0%</td>
                </tr>
              </tbody>
            </table>
          </div>
