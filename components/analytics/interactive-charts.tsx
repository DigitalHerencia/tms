...
import { Activity, BarChart3, Eye, TrendingDown, TrendingUp, Zap } from 'lucide-react';
...
export function InteractiveCharts({ data, timeRange, orgId }: InteractiveChartsProps) {
  ...
  const calculateTrend = (current: number, previous: number) => {
    ...
    return {
      ...
      arrow: change > 0 ? TrendingUp : change < 0 ? TrendingDown : Activity,
    };
  };
  ...
  const renderChart = () => {
    ...
    const combinedData = [...chartData, ...predictions.map((p) => ({ ...p, isPrediction: true }))];
      ...
      case 'composed':
        return (
          <ComposedChart data={combinedData}>
            ...
            />
            <Bar yAxisId="right" dataKey="loads" fill={CHART_COLORS[0]} />
            <Line
              yAxisId="left"
              type="monotone"
              dataKey="value"
          ...
          <Tabs value={selectedChart} onValueChange={setSelectedChart}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  {[
                    ...
                    const trend = calculateTrend(metric.value, metric.target);
            ...
            <TabsContent value="operational" className="mt-6">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="text-sm">Driver Scores</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <ResponsiveContainer width="100%" height={200}>
                      <PieChart>
            ...
            >
              ...
              <ResponsiveContainer width="100%" height={400}>
                <LineChart data={drilldownData.data}>
                  ...
                  <Line type="monotone" dataKey="loads" stroke={CHART_COLORS[1]} strokeWidth={2} />
                </LineChart>
              </ResponsiveContainer>
            </motion.div>
          </motion.div>
