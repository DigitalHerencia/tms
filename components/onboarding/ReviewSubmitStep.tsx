            ...
            <CardContent className="space-y-2">
              ...
              {formData.dotNumber && (
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-white">{formData.dotNumber}</span>
                </div>
              )}
              {formData.mcNumber && (
                <div className="flex justify-between">
                  <span className="text-gray-400">MC Number:</span>
                  <span className="font-medium text-white">{formData.mcNumber}</span>
                </div>
              )}
            </CardContent>
          </Card>
          ...
          <Card className="bg-neutral-800 border-neutral-700">
            ...
            <CardContent className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-white">{formData.organizationId}</span>
              </div>
              {formData.inviteCode && (
                <div className="flex justify-between">
                  <span className="text-gray-400">Invite Code:</span>
                  <span className="font-medium text-white">{formData.inviteCode}</span>
                </div>
              )}
            </CardContent>
          </Card>
