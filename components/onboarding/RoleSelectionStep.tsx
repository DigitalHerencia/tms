...
type RoleSelectionStepProps = Pick<OnboardingStepProps, 'formData' | 'updateFormData' | 'onNext'> & {
  onPrev: () => void;
};
        ...
        {selectedRole && (
          <div className="p-4 border border-neutral-700 rounded-lg bg-neutral-800">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-white">{selectedRole.label}</h3>
                ...
                {formData.role === SystemRoles.ADMIN && (
                  <div className="mt-3 p-3 bg-purple-900/20 rounded-lg border border-purple-700/30">
                    <p className="text-sm text-purple-300 font-medium">👑 Admin Path Ahead!</p>
                    <p className="text-xs text-purple-400 mt-1">
                      As an admin, you'll set up your company information, DOT numbers, and initial
                      settings.
                    </p>
                  </div>
                )}
                ...
                {formData.role !== SystemRoles.ADMIN && formData.role !== '' && (
                  <div className="mt-3 p-3 bg-blue-900/20 rounded-lg border border-blue-700/30">
                    <p className="text-sm text-blue-300 font-medium">🎯 Employee Path</p>
